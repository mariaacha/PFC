...
public interface TIntSet extends TIntCollection {
    ...
    /**
     * Adds all of the elements in the <tt>T#E#Collection</tt> to the set.
     *
     * @param collection a <code>T#E#Collection</code> value
     * @return true if the set was modified by the add all operation.
     */
    ...
    /**
     * Removes all of the elements in <tt>T#E#Collection</tt> from the set.
     *
     * @param collection a <code>T#E#Collection</code> value
     * @return true if the set was modified by the remove all operation.
     */
